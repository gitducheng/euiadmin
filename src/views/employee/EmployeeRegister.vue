<template>
  <el-container id="aside">
    <vAsideSpace />
    <el-container>
      <el-header :height="head_height" :style="{backgroundColor:head_background_color,minWidth:'800px'}">
        <vHeadSpace />
      </el-header>
      <vTabSpace/>
      <el-main id="main" :style="{ backgroundColor: main_background_color }">
        <EmployeeRegisterSpace />
      </el-main>
    </el-container>
  </el-container>
</template>
...
export default {
  components: {
    EmployeeRegisterSpace:resolve=>{require(['@/components/employee/EmployeeRegisterSpace'],resolve)},
  },
 data(){
      return{
