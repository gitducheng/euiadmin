...
const routes = [{
  ...
  },
  {
    path: '/module/tool',
    name: 'animate',
    component: resolve => require(['@/views/module/CommonTool.vue'], resolve),
    meta: {
      title: 'Eui动画',
      login_state: true,
      vist_label: ['super_admin', 'admin']
  ...
  // 网站管理
  {
    path: '/web/home',
    name: 'app_admin',
    component: resolve => require(['@/views/web/WebHome.vue'], resolve),
    meta: {
      title: '搜索音乐',
      login_state: false,
      vist_label: ['super_admin', 'admin']
  ...
  },
  {
    path: '/web/tags',
    name: 'app_admin',
    component: resolve => require(['@/views/web/WebTags.vue'], resolve),
    meta: {
      title: '搜索音乐',
      login_state: false,
      vist_label: ['super_admin', 'admin']
